const EXERCISES = {
  push: {
    ...
    variants: [
      ...
      { name: 'Diamond/deficit push-ups (paralletter)', type: 'reps', baseReps: 6, setsTarget: 3, perSide: false },
      { name: 'Archer push-ups', type: 'reps', baseReps: 5, setsTarget: 3, perSide: true },
      { name: 'Pseudo planche push-ups', type: 'reps', baseReps: 5, setsTarget: 3, perSide: false }
    ]
  },
  ...
  dips: {
    ...
    variants: [
      ...
      { name: 'Fulde ring dips', type: 'reps', baseReps: 6, setsTarget: 3, perSide: false },
    ...
    calibration: { name: 'Ring support hold', type: 'hold', baseHoldSeconds: 20, setsTarget: 3 }
  },
  ...
  pullRow: {
    ...
    variants: [
      ...
      { name: 'Ring rows, krop vandret', type: 'reps', baseReps: 8, setsTarget: 3, perSide: false },
  ...
  pullVertical: {
    ...
    variants: [
      ...
      { name: 'Fulde ring pull-ups', type: 'reps', baseReps: 5, setsTarget: 3, perSide: false },
  ...
  coreSkill: {
    ...
    variants: [
      ...
      { name: 'Fuld L-sit hold', type: 'hold', baseHoldSeconds: 10, setsTarget: 3, perSide: false },
      { name: 'L-sit pull-ups/V-sit hold', type: 'hold', baseHoldSeconds: 10, setsTarget: 3, perSide: false },
  ...
  handstand: {
    ...
    variants: [
      ...
      { name: 'Negative håndstand push-ups (væg)', type: 'reps', baseReps: 3, setsTarget: 3, perSide: false },
